      ...
      <div className="container my-4">
        <div class="row">
          <div class="col-sm-6">
            <div class="card">
              <div class="card-body">
                <h5 class="card-heading">Weather App</h5>
                <p class="card-text"><b className='card-heading'>Description:</b><br />
                  ...
                  <br /><a href="https://weathervarun.netlify.app/" class="m-3 btn btn-success">Go to Project</a>
                  <a href="https://github.com/VarunSharma3520/weather" class="mx-2 btn btn-light"><svg aria-hidden="true" height="24" viewBox="0 0 16 16" version="1.1" width="24" data-view-component="true" class="octicon octicon-mark-github">
          ...
          <div class="col-sm-6">
            <div class="card">
              <div class="card-body">
                <h5 class="card-heading">Google Clone</h5>
