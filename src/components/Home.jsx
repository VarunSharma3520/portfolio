  ...
  return (
    <div className=''>
      ...
      <div className="text-center">
        <img src="https://res.cloudinary.com/dlfuvp7oc/image/upload/v1705546638/djsieqzgrp4irrfphs0l.png" className="rounded-circle container-fluid my-4" style={{ width: "18rem" }} alt="..." />
      </div>
